...
<!--
Transformation is a very creative process. One that rarely looks the same from one project to the next. The most important thing is to understand it's role and to have an idea of the major types of transformations thaat can be done.
...
<!--
This can be challenging. But it becomes a bit easier when you have a clear idea of the analysis you want to do. In this case, I created the research question so you the connection between the data and the analysis may not be as clear as it would be in a real project that you are working on.
...
<!-- Good job. I really love to see you looking for ouside resources. This will help you work towards being an autonomous learner! -->
...
Again, this is something that will come with practice --if you continue on with R programming in your future endeavors.
